...
<?php require_once('includes/header.php'); ?>
		<div data-role="content">
			<h3>Welcome, <?php echo $my_name; ?>, to Higgyball13!</h3>
		...
		<?php } ?>
			...
			<ul>
				...
				<li><a href="mvp.php" data-ajax="false">MVP Voting</a> allows you to vote for the Higgyball13 Male and Female MVPs. Anyone can vote (once!)</li>
